...
UrlFollower.prototype.initialize = function(cb) {
  ...
  if (this._isInitialized === true) {
    return cb(new Error('URLFollow: Widget is already initialized'));
  }
  ...
  async.parallel(tasks, function(err, result) {
    ...
    if (self._isCrossDomain(roomUrl)) {
      return cb(new Error('URLFollow: Cross-Domain Init Denied'));
    }
...
UrlFollower.prototype.destroy = function(cb) {
  if (!this._isInitialized) {
    return cb(new Error('URLFollow: Widget is not yet initialized'));
  }
